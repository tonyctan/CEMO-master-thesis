...
Even more concerning is the pervasive global distribution of financial illiteracy. Low levels of financial literacy are observed not only in less developed countries such as India and Indonesia \parencite{cole:2009} but also in advanced economies such as the USA \parencite{gale:2012, huston:2012}, Germany \parencite{bucherkoenen:2017} and OECD countries \parencite{lusardi:2015a}.
...
This chapter provides in-depth explanations of the two concepts underpinning this research project: \poscite{wang:2016} school climate framework and PISA 2018's approach to quantifying students' financial literacy.

\section{School Climate}
