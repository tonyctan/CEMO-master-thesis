...
This chapter provides in-depth explanations of the two concepts underpinning this research project: \poscite{wang:2016} school climate framework (\cref{sec:sc}) and PISA 2018's approach to quantifying students' financial literacy (\cref{sec:flit}) before stating the research questions in \cref{sec:rq}.
