...
pub.header <- c("STRATIO", "EDUSHORT", "MALE", "IMMI1GEN", "IMMI2GEN", "ESCS", "FCFMLRTY", "FLCONFIN", "FLSCHOOL", "FLFAMILY", "NOBULLY", "BRA", "BGR", "CAN", "CHL", "EST", "FIN", "GEO", "IDN", "ITA", "LVA", "LTU", "NLD", "PER", "POL", "PRT", "RUS", "SRB", "SVK", "ESP", "USA", "PV1MATH", "PV2MATH", "PV3MATH", "PV4MATH", "PV5MATH", "PV6MATH", "PV7MATH", "PV8MATH", "PV9MATH", "PV10MATH", "PV1READ", "PV2READ", "PV3READ", "PV4READ", "PV5READ", "PV6READ", "PV7READ", "PV8READ", "PV9READ", "PV10READ", "PV1FLIT", "PV2FLIT", "PV3FLIT", "PV4FLIT", "PV5FLIT", "PV6FLIT", "PV7FLIT", "PV8FLIT", "PV9FLIT", "PV10FLIT", "CNTRYID", "W_STU", "W_SCH", "CNTSCHID")

# Use data.table for better RAM management
library(data.table); setDTthreads(0) # 0 means all the available cores

# Call in imputed data sets
...
# Re-arrange columns
pub1 <- pub1[, c(12:31, 62, 65, 63, 52, 3:11, 64, 1:2)]
pub2 <- pub2[, c(12:31, 62, 65, 63, 53, 3:11, 64, 1:2)]
pub3 <- pub3[, c(12:31, 62, 65, 63, 54, 3:11, 64, 1:2)]
pub4 <- pub4[, c(12:31, 62, 65, 63, 55, 3:11, 64, 1:2)]
pub5 <- pub5[, c(12:31, 62, 65, 63, 56, 3:11, 64, 1:2)]
pub6 <- pub6[, c(12:31, 62, 65, 63, 57, 3:11, 64, 1:2)]
pub7 <- pub7[, c(12:31, 62, 65, 63, 58, 3:11, 64, 1:2)]
pub8 <- pub8[, c(12:31, 62, 65, 63, 59, 3:11, 64, 1:2)]
pub9 <- pub9[, c(12:31, 62, 65, 63, 60, 3:11, 64, 1:2)]
