...
% Link mediators with outcome var
    \draw[blue,->] (fami1.east) to node[above,sloped,pos=0.6] {\press{0.195}{***}{0.014}} (flit1.west);
    \draw[blue,->] (conf1.east) to node[below,sloped,pos=0.6] {\press{0.080}{***}{0.010}} (flit1.west);
...
% Arc covariances
    ...
    \draw[<->,dashed] (S2.south) to [bend left] node[below,sloped,pos=0.78] {\press{0.057}{}{0.045}} (R2.north);
...
% Link input vars with output var
    ...
    \draw[->] (fki3.east) to node[below,sloped] {\press{0.700}{***}{0.089}} (flit3.west);
