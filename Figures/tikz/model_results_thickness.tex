...
% Link input vars with output var
    ...
    \draw[->,line width=2*0.287mm] (R2.east) to node[above,sloped] {\press{-0.287}{***}{0.039}} (flit2.west);

    \draw[black!25!white,->,line width=2*0.130mm] (st2.east) to node[below,sloped] {\press{-0.130}{***}{0.026}} (flit2.west);
