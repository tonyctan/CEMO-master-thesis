\ltable{tab:FKIsource}{Data Sources for FKI Computation}{
    ...
    WB-dev & 19    & GDP per capita, PPP (current international \$) & 2018 \\
    \rowcolor[rgb]{ .9,  .9,  .9} \multicolumn{4}{c}{Educational Training} \\
    WD-ed & 19 \textbackslash\ Russia & Graduates from ISCED 7 programmes in tertiary education, both sexes (number) & 2013--\textbf{2018} \\
    ...
    HDR & 19    & Dimension = Education; Education = Mean years of schooling (years) & 2018 \\
    ...
    WB-dev & 19    & Individuals using the Internet (\% of population) & 2009--\textbf{2018} \\
    \rowcolor[rgb]{ .9,  .9,  .9} \multicolumn{4}{c}{Need} \\
    WB-fin & 19 \textbackslash\ Georgia & Pension fund assets to GDP (\%) & 2008--\textbf{2018} \\
    ...
    WB-dev & 19    & Household and NPISHs final consumption expenditure, PPP (current international \$) & 2018 \\
...
\begin{itemize}
    ...
    \item[$^\text{b}$] ``19'' = the 19 participating countries in 2018 \textsc{PISA} financial literacy test: Brazil, Bulgaria, Chile, Estonia, Finland, Georgia, Indonesia, Italy, Latvia, Lithuania, the Netherlands, Peru, Poland, Portugal, Russian Federation, Serbia, Slovak Republic, Spain, and the USA. ``\textbackslash'' = exluding or except
